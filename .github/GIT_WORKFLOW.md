...
This project follows Semantic Versioning (SemVer). When you create a pull request, you should update the version number in the `CHANGELOG.md` file according to the changes you've made.
...
5.  Give the PR a clear title and a description of the changes.
